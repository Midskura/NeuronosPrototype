...
export function BrokerageBookings({ currentUser, pendingBookingId, initialTab, highlightId }: BrokerageBookingsProps = {}) {
  ...
  const uniqueEntryTypes = Array.from(new Set(bookings.map(b => b.entryType).filter(Boolean)));
  ...
  const filteredBookings = getFilteredByTab().filter(booking => {
    ...
    // Entry Type filter
    if (entryTypeFilter !== "all" && booking.entryType !== entryTypeFilter) return false;
      ...
      <div style={{ minHeight: "100vh", background: "#FFFFFF" }}>
        ...
        <div style={{ padding: "32px 48px 24px 48px" }}>
          <div style={{ 
            ...
            <div>
              ...
              <p style={{ 
                ...
                Manage customs brokerage bookings and clearance
              </p>
            </div>
          ...
          <div style={{ position: "relative", marginBottom: "24px" }}>
            ...
            <input
              type="text"
              placeholder="Search by Booking ID, Customer, MBL/MAWB, or Project Number..."
              value={searchTerm}
                    ...
                    >
                      <td className="py-4 px-4">
                        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                          <FileCheck size={20} color="#0F766E" style={{ flexShrink: 0 }} />
                          <div>
                            <div style={{ 
                              fontSize: "14px", 
                              fontWeight: 600, 
                      ...
                      <td className="py-4 px-4">
                        <div style={{ fontSize: "13px", color: "#12332B" }}>
                          {booking.mblMawb || <span style={{ color: "#667085" }}>—</span>}
                        </div>
                      </td>
                      <td className="py-4 px-4">
                        <div style={{ 
