      ...
      <div className="space-y-2.5">
          ...
          <div className="space-y-2">
              <input 
                  ...
                  className="w-full px-3.5 py-2 text-sm border border-[var(--theme-border-default)] rounded-lg focus:border-[var(--theme-action-primary-bg)] focus:ring-1 focus:ring-[var(--theme-action-primary-bg)] outline-none transition-all placeholder:text-[var(--theme-text-muted)]"
                  placeholder="Name"
              />
              <input 
                  type="text" 
                  ...
                  className="w-full px-3.5 py-2 text-sm border border-[var(--theme-border-default)] rounded-lg focus:border-[var(--theme-action-primary-bg)] focus:ring-1 focus:ring-[var(--theme-action-primary-bg)] outline-none transition-all bg-[var(--theme-bg-surface-subtle)] placeholder:text-[var(--theme-text-muted)]"
