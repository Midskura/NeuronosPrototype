...
const NAV: NavSection[] = [
  {
    ...
    entities: [
      ...
      { key: "bd-inquiries", entityType: "quotation", label: "Inquiries", Icon: ShoppingCart, table: "quotations", columns: "id, quotation_name, quote_number, customer_name, status", getLabel: (r) => r.quote_number || r.quotation_name || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "quote_number", extraFilters: { quotation_type: "spot" } },
      { key: "bd-projects", entityType: "project", label: "Projects", Icon: Briefcase, table: "projects", columns: "id, project_number, customer_name, status", getLabel: (r) => r.project_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "project_number" },
      { key: "bd-contracts", entityType: "contract", label: "Contracts", Icon: Handshake, table: "quotations", columns: "id, quotation_name, quote_number, customer_name, status", getLabel: (r) => r.quote_number || r.quotation_name || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "quote_number", extraFilters: { quotation_type: "contract" } },
    ],
  },
  {
    id: "pricing",
    ...
    entities: [
      ...
      { key: "pricing-quotations", entityType: "quotation", label: "Quotations", Icon: FileText, table: "quotations", columns: "id, quotation_name, quote_number, customer_name, status", getLabel: (r) => r.quote_number || r.quotation_name || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "quote_number", extraFilters: { quotation_type: "spot" } },
      { key: "pricing-projects", entityType: "project", label: "Projects", Icon: Briefcase, table: "projects", columns: "id, project_number, customer_name, status", getLabel: (r) => r.project_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "project_number" },
      { key: "pricing-contracts", entityType: "contract", label: "Contracts", Icon: Handshake, table: "quotations", columns: "id, quotation_name, quote_number, customer_name, status", getLabel: (r) => r.quote_number || r.quotation_name || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "quote_number", extraFilters: { quotation_type: "contract" } },
    ],
  },
  {
    id: "ops",
    ...
    entities: [
      { key: "ops-forwarding", entityType: "booking", label: "Forwarding", Icon: Container, table: "bookings", columns: "id, booking_number, customer_name, status, service_type", getLabel: (r) => r.booking_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "booking_number", extraFilters: { service_type: "Forwarding" } },
      { key: "ops-brokerage", entityType: "booking", label: "Brokerage", Icon: Palette, table: "bookings", columns: "id, booking_number, customer_name, status, service_type", getLabel: (r) => r.booking_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "booking_number", extraFilters: { service_type: "Brokerage" } },
      { key: "ops-trucking", entityType: "booking", label: "Trucking", Icon: Truck, table: "bookings", columns: "id, booking_number, customer_name, status, service_type", getLabel: (r) => r.booking_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "booking_number", extraFilters: { service_type: "Trucking" } },
      { key: "ops-marine-insurance", entityType: "booking", label: "Marine Insurance", Icon: Ship, table: "bookings", columns: "id, booking_number, customer_name, status, service_type", getLabel: (r) => r.booking_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "booking_number", extraFilters: { service_type: "Marine Insurance" } },
      { key: "ops-others", entityType: "booking", label: "Others", Icon: FileText, table: "bookings", columns: "id, booking_number, customer_name, status, service_type", getLabel: (r) => r.booking_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "booking_number", extraFilters: { service_type: "Others" } },
    ],
  },
  {
    id: "accounting",
    ...
    entities: [
      { key: "acct-projects", entityType: "project", label: "Projects", Icon: Briefcase, table: "projects", columns: "id, project_number, customer_name, status", getLabel: (r) => r.project_number || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "project_number" },
      { key: "acct-contracts", entityType: "contract", label: "Contracts", Icon: Handshake, table: "quotations", columns: "id, quotation_name, quote_number, customer_name, status", getLabel: (r) => r.quote_number || r.quotation_name || r.id?.slice(0, 8), getSublabel: (r) => r.customer_name || "", searchColumn: "quote_number", extraFilters: { quotation_type: "contract" } },
      { key: "acct-bookings", entityType: "booking", label: "Bookings", Icon: Package, table: "bookings", columns: "id, booking_number, customer_name, status, service_type", getLabel: (r) => r.booking_number || r.id?.slice(0, 8), getSublabel: (r) => [r.customer_name, r.service_type].filter(Boolean).join(" - "), searchColumn: "booking_number" },
