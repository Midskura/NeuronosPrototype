    ...
    >
      ...
      >
            ...
            {editMode ? (
              <>
                <Button
                  ...
                  variant="outline"
                  className="h-9 px-4 rounded-lg border-[var(--theme-border-default)] text-[13px]"
        ...
        <div className="flex flex-1 overflow-hidden">
              ...
              <table className="w-full" style={{ minWidth: "1800px" }}>
                <thead>
                  <tr className="bg-[#D4AF37]">
                    <th
                      className="px-2 py-2 text-left text-[10px] text-[var(--theme-text-primary)] uppercase border-r border-[#000000]"
                      style={{ fontWeight: 700, width: "140px" }}
                    >
                      Employees
                    </th>
                    <th
                      className="px-2 py-2 text-center text-[10px] text-[var(--theme-text-primary)] uppercase border-r border-[#000000]"
                ...
                <tbody className="bg-[var(--theme-bg-surface)]">
                  {MOCK_PAYROLL_DATA.map((row, idx) => (
                    <tr key={idx} className="border-b border-[var(--theme-border-default)]">
                      <td
                        className="px-2 py-2 text-[11px] text-[var(--theme-text-primary)] border-r border-[var(--theme-border-default)]"
                        style={{ fontWeight: 500 }}
                      >
                        {row.employeeName}
                      </td>
                      <td className="px-2 py-2 text-[11px] text-[var(--theme-text-primary)] text-right border-r border-[var(--theme-border-default)] font-mono">
                      ...
                      <td className="px-2 py-2 text-[11px] text-[var(--theme-text-primary)] text-center border-r border-[var(--theme-border-default)] font-mono">
                        {row.noOfDays}
                      </td>
                      <td className="px-2 py-2 text-[11px] text-[var(--theme-text-primary)] text-right border-r border-[var(--theme-border-default)] font-mono">
                      ...
                      <td className="px-2 py-2 text-[10px] text-[var(--theme-text-primary)] text-center border-r border-[var(--theme-border-default)]">
                        {row.leaveWPayDays || "-"}
                      </td>
                      <td className="px-2 py-2 text-[11px] text-[var(--theme-text-primary)] text-right border-r border-[var(--theme-border-default)] font-mono">
                        {row.leaveWPay > 0
                      ...
                      <td
                        className="px-2 py-2 text-[11px] text-[var(--theme-text-primary)] text-right border-r border-[var(--theme-border-default)] font-mono"
                        style={{ fontWeight: 600 }}
                      >
                      ...
                      <td className="px-2 py-2 border-[var(--theme-border-default)]"></td>
                    </tr>
                  ))}
                  {/* TOTAL Row */}
                  <tr className="bg-[var(--theme-bg-page)] border-t-2 border-[#000000]">
                    <td
                      className="px-2 py-2 text-[11px] text-[var(--theme-text-primary)] border-r border-[var(--theme-border-default)]"
                      style={{ fontWeight: 700 }}
                    >
                    ...
                    <td className="px-2 py-2 border-r border-[var(--theme-border-default)]"></td>
                    <td className="px-2 py-2 border-r border-[var(--theme-border-default)]"></td>
                    <td className="px-2 py-2 border-r border-[var(--theme-border-default)]"></td>
                    <td className="px-2 py-2 border-r border-[var(--theme-border-default)]"></td>
                    <td
          ...
          <div
            className="border-l border-[var(--theme-border-default)] bg-[var(--theme-bg-page)] flex-shrink-0 p-6 overflow-y-auto"
            style={{ width: "280px" }}
          >
            <h4
            ...
            <div className="space-y-4">
              <div>
                <Label className="text-[10px] text-[var(--theme-text-muted)] mb-2 block uppercase">
                  Formula
                </Label>
                <div className="text-[12px] text-[var(--theme-text-primary)]">
                  Standard PH – JJB
                </div>
              </div>
              <div>
                ...
                <div className="text-[12px] text-[var(--theme-text-primary)]">2025-Q3</div>
              </div>
              <div>
                <Label className="text-[10px] text-[var(--theme-text-muted)] mb-2 block uppercase">
                  Rounding
                </Label>
                <div className="text-[12px] text-[var(--theme-text-primary)]">Nearest peso</div>
              </div>
              <div className="pt-4 border-t border-[var(--theme-border-default)]">
